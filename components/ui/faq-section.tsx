...
export default function FAQWithSpiral({ faqs: initialFaqs }: { faqs?: { q: string, a: string }[] }) {
  ...
  const randomize = () => {
    ...
    setCfg((c) => ({
      ...
      background: useLightBg ? "#f5f5f5" : "var(--color-surface)",
      color: useLightBg
    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-16">
        ...
        <header className="mb-10 flex items-end justify-between border-b border-white/20 pb-6">
          <div>
            <h1 className="text-4xl md:text-6xl font-semibold tracking-tight">FAQ</h1>
